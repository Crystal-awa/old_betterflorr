...
// @grant        none
// ==/UserScript==
const audio = new Audio('https://raw.githubusercontent.com/Crystal-awa/superpingsound/main/Rebound.mp3');
(function() {
    'use strict';
    const banben='1.4.1'//设置版本号，更新的时候别忘了:D
    ...
    const switchNames = ["super播报", "防顶号", "聊天","super播报声音提醒","日志"];
    ...
    function updateLogInterface() {
        const isLogEnabled = getSwitchState(5);
        if (isLogEnabled) {
