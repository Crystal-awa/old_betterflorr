...
(function() {
    ...
    superping.style.maxHeight = '180px';  
    superping.style.height = '180px'
    superping.style.overflowY = 'auto';
    superping.style.backgroundColor = 'rgba(255, 255, 255, 0.8)';  
    ...
    title.textContent = '';
    title.innerHTML = '<span style="color: gold; font-size: 14px; font-weight: bold; text-shadow: 2px 2px 5px rgb(0, 0, 0);">super播报</span>';  
    ...
    function displayText(text) {
        ...
        const content = superping.querySelector('div');  
